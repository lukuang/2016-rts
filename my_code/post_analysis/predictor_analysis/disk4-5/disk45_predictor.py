...
RULE = {
    ...
    RetrievalMethod.dirichlet:"method:dirichlet,mu:1000",
    RetrievalMethod.pivoted:"method:pivoted,s:0.05",
    RetrievalMethod.bm25:"method:okapi,b:0.3",
}

class Disk45Qrel(object):
    def __init__(self,clarity_query_file):
        self._clarity_query_file = clarity_query_file
        self.qids = []
...
class LocalTermRelatednessAverage(LocalTermRelatedness):
    def __init__(self,qrel,top_index_dir,query_dir,bin_file,result_dir,tune_documents=50):
