...
map<string, map<string, float> >  get_term_relatedness(indri::collection::Repository& r, map<string, vector <vector<string> > > query_2words_vector,const int& n,map<string, vector<string> > queries){
...
int main(int argc, char** argv){
    ...
    try {
        ...
        map<string, map<string, float> > term_relatedness = get_term_relatedness(r,query_2words_vector,n,queries);
